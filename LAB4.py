...
num1 = int(input("Enter a number between 1-999 (inclusive):\n"))
num2 = int(input("Enter a number between 1-999 (inclusive):\n"))

if num1 > num2:
    print(words[num2:num1])
else:
    print("Invalid input! The first number must be greater than the second number.")
...
for i in range(8):
    ...
    if 3 < user_number <= 7:
        ...
        print("Your password is : ", string[::-1])
        if user_number < 5:
            shorter.add(string[::-1])
        else:
            longer.add(string[::-1])
    else:
        print("Invalid input!")
...
passwords = shorter.union(longer)
...
try:
    number = int(input("Enter a key to delete: \n"))
    del Dict[number]
    print("Dictionary after deletion: ", Dict)
except KeyError:
    print("The key ", number, "does not exist!")
...
print("After the Deletion of the key 'Nat': ", united_we_stand)

print("{:<10} {}".format("Name", "Age"))
for name in sorted(united_we_stand):
    print("{:<10} {}".format(name, united_we_stand[name]))

print("Maximum value is the: ", max(united_we_stand.values()))
print("Minimum value is the: ", min(united_we_stand.values()))
